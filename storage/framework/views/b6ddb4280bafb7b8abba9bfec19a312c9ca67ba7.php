...
<div class="container">
        <div class="row justify-content-center">
            <img src="<?php echo e(asset('image/gambar1.png')); ?>" name="aboutme" width="1500" height="250">
                                    ...
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column3 text-center table-warning">
                                            <select id="T" name="jenis tanah" class="col-md-10">
                                                ...
                                                <?php $__currentLoopData = $jenis_tanah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tanah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($tanah->nama_tanah); ?>"><?php echo e(ucfirst($tanah->nama_tanah)); ?></option>
